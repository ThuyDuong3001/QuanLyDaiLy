        ...
        if (evt.getSource() == jButton7){
            ...
            try(Connection conn = ConnectionUtils.getMyConnection()){
                if (conn != null) {
                    ...
                    st.executeQuery("delete from phieuxuathang where maphieuxuat = \'" + mpx + "\'");
        ...
        if (evt.getSource() == jButton3){
            ...
            try (Connection conn = ConnectionUtils.getMyConnection()){
                if (conn != null) {
                    ...
                    String query1 = "select * from phieuxuathang where maphieuxuat = \'" + mapx + "\' or madaily = \'" + mapx + "\'";
