...
//                        ));
                    ...
                    truycap.maphieunhap = mpn;
                    System.out.println(truycap.maphieunhap);
                    truycap.date = date;
                    
                    String query = "insert into phieunhaphang values (\'" + mpn +"\'"+  ",DATE \'" + truycap.date + "\', 0, \'" + truycap.cmnd + "\')"; 
                    st.executeQuery(query);
                    System.out.println(query);  
                    st.executeQuery("delete from phieunhaphang where maphieunhap = \'" + mpn + "\'");
        ...
        if (evt.getSource() == jButton3){
            try (Connection conn = ConnectionUtils.getMyConnection()){
                if (conn != null) {
                    ...
                    String query1 ="select * from PHIEUNHAPHANG where MaPhieuNhap = " + "\'"+ mapn +"\' or cmnd = \'" + mapn + "\'";;
