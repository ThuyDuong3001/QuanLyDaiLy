 ...
 * @author NDAT_UIT
 */
public class baocaocongnotest extends javax.swing.JFrame {

    /**
     * Creates new form QuyCheToChuc_TN
     */
    public baocaocongnotest() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(baocaocongnotest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new baocaocongnotest().setVisible(true);
            }
        });
    }
