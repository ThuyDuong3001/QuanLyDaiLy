...
public class BaoCaoDoanhSo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabeltongdoanhso = new javax.swing.JLabel();
        jLabeldoanhso = new javax.swing.JLabel();
        ...
        jLabeltongdoanhso.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        jLabeldoanhso.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
                ...
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabeltongdoanhso)

                                .addComponent(jLabeldoanhso)
                                )
            ...
            jPanel1Layout.setVerticalGroup(
                ...
                .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addComponent(jButtonxuat).addGap(30,30,30)
                    .addContainerGap())
            );
        ...
        jLabel2.setText("Báo cáo doanh số");
                ...
                if (conn != null) {
                	...
                	if (jTextFieldthang.getText().isBlank() & !jTextFieldnam.getText().isBlank()) {
    	    			...
    	    			for (int i = 0; i< index_madaily;i++) {
                        	...
                        	tongtrigia += Integer.parseInt(value[2]);
                        ...
                        jLabeltongdoanhso.setForeground(new java.awt.Color(0, 51, 255));
                        jLabeldoanhso.setForeground(new java.awt.Color(0, 51, 255));

                        jLabeldoanhso.setText(String.valueOf(tongtrigia));
                        
                        jLabeltongdoanhso.setText("Tổng doanh số: ");
	    			...
	    			for (int i = 0; i< index_madaily;i++) {
		    			CallableStatement cstmt;
		    			cstmt = conn.prepareCall("{call Pro_BaoCaoDoanhSo(?,?,?,?,?,?)}");
                    	...
                    	value[3] = Float.toString(cstmt.getFloat(6));
                    	tongtrigia += Integer.parseInt(value[2]);
    ...
    private javax.swing.JLabel jLabeltongdoanhso;
    private javax.swing.JLabel jLabeldoanhso;
